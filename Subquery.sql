...
--  we included an * in our* SELECT* statement. You will need to be 
-- sure to alias your table.
SELECT *
...
-- Finally, here we are able to get a table that shows the average 
-- number of events a day for each channel.
