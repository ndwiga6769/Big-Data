/* There are 10 IPL team. write an sql query
such that each team play with 
every other team just once. */
...
select te.team_name as team, op.team_name as opponent
from matches te
join matches op
on te.id < op.id

/*2 There are 10 IPL team. write an sql query
such that each team play with 
